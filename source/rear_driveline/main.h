...
// Magnometer
// #define MAG_REAR_Port (GPIOB)
// #define MAG_REAR_Pin (7)

// IR Temp INFKL-800
#define BRAKE_TEMP_RL_GPIO_Port (GPIOA)
#define BRAKE_TEMP_RL_Pin       (2)
#define BRAKE_TEMP_RL_ADC_CH    (2)
#define BRAKE_TEMP_RR_GPIO_Port (GPIOA)
#define BRAKE_TEMP_RR_Pin       (3)
#define BRAKE_TEMP_RR_ADC_CH    (3)
